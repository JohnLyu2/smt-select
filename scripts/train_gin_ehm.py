#!/usr/bin/env python3
"""Train GIN multi-head regressor for algorithm selection (PAR2 prediction per solver)."""
...
def main() -> None:
    import argparse
    parser = argparse.ArgumentParser(description="Train GIN regression for algorithm selection")
    ...
    logging.info("Training: %d instances, %d solvers", len(multi_perf_data), multi_perf_data.num_solvers())
